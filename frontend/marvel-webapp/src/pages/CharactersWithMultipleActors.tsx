...
const CharactersWithMultipleActors: React.FC = () => {
  ...
  return (
    <Box>
      <Typography variant="h4" gutterBottom>Characters with Multiple Actors</Typography>
      <Typography variant="body1" gutterBottom>
        Discover Marvel characters who have been played by multiple actors across different movies.
      </Typography>
      <List>
