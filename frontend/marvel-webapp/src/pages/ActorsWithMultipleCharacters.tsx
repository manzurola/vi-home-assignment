...
const ActorsWithMultipleCharacters: React.FC = () => {
  ...
  return (
    <Box>
      <Typography variant="h4" gutterBottom>Actors with Multiple Characters</Typography>
      <Typography variant="body1" gutterBottom>
        Explore actors who have portrayed more than one character in the Marvel universe.
      </Typography>
      <List>
