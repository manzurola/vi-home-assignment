...
export class AppService {
   ...
   */
  getMoviesPerActor(page: number, pageSize: number): Promise<MoviesPerActorResponse> {
   ...
   */
  getActorsWithMultipleCharacters(page: number, pageSize: number): Promise<ActorsWithMultipleCharactersResponse> {
   ...
   */
  getCharactersWithMultipleActors(page: number, pageSize: number): Promise<CharactersWithMultipleActorsResponse> {
